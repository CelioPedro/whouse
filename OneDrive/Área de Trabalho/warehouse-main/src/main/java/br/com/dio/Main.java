...
public class Main {
    ...
    public static void main(String[] args) {
        // Inicia o servidor HTTP para integração com storefront
        startServer();
    ...
    public static long getOutOfDateCount() {
        return stock.stream().filter(b -> b.validate().isBefore(LocalDate.now())).count();
    }

    public static void startServer() {
        try {
            StorefrontConnector.start();
        } catch (IOException e) {
